...
export default function LoginPage() {
  ...
  return (
    <main className="w-full max-w-md z-10 mx-auto mt-20 mb-20 px-4">
      ...
      <div className="bg-surface dark:bg-[#152e2a] rounded-2xl shadow-soft p-8 sm:p-10 border border-white/50 dark:border-mosque/20 backdrop-blur-sm relative">
        {errorMSG && (
        ...
        <div className="space-y-4">
          ...
          >
            <div className="absolute inset-0 bg-accent/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out"></div>
            <svg
              className="w-5 h-5 relative z-10 fill-current text-nordic-dark dark:text-white"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
            >
        ...
        <p className="mt-8 text-center text-sm text-nordic-dark/70 dark:text-gray-400">
          ...
          <Link
            href="/login"
            className="font-semibold text-mosque hover:text-mosque-dark transition-colors"
          >
            Sign up
          </Link>
        </p>
