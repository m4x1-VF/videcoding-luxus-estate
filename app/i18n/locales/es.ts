...
const es: Translations = {
  ...
  home: {
    ...
    featuredSubtitle: "Propiedades seleccionadas para el ojo más exigente.",
    viewAll: "Ver todas",
    newInMarketTitle: "Nuevas en el Mercado",
    newInMarketSubtitle: "Oportunidades frescas agregadas esta semana.",
  },
